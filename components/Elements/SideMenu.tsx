...
const SideMenu: FC<ISideMenu> = ({menuActive, setMenuActive}) => {
	...
	return (
		<>
			<nav
				className={` sideMenu ${
					menuActive ? `translate-x-[0%]` : "hidden translate-x-[-150%]"
				} transition-all duration-[2s] ease-in-out`}
			>
				<div className="relative flex flex-col w-[30rem] h-screen overflow-x-hidden overflow-y-auto bg-white border-solid border-r-4 border-primary-default bg-cover bg-center bg-no-repeat">
					...
					<div className="mt-20 h-full bg-primary-default px-6 py-6">
						<motion.div
							initial={initial}
							variants={stagger}
							whileInView="animate"
						...
						>
							<h4 className="my-5 font-schaboCondensed uppercase text-white text-lg lg:text-xl tracking-[0.05rem] leading-[0.5rem]">
								Contact Links
							</h4>
							...
							>
								...
								>
									...
									<Link
										className="text-base tracking-wide text-white hover:opacity-70"
								...
								>
									...
									<Link
										className="text-base tracking-wide text-black hover:opacity-70"
