...
const TestimonialsCard: FC<ITestimonialsCard> = ({
	...
	return (
		<>
			<div className="flex flex-col items-center justify-center p-6 min-w-full lg:min-w-[400px] h-full min-h-[225px] bg-white border-2 border-pureBlack border-solid">
				<motion.div
					initial={initial}
					variants={stagger}
					whileInView="animate"
				...
				>
					...
					<div className="flex flex-wrap items-center justify-between px-2 -m-2 gap-4">
						<div className="flex items-center justify-between">
							...
							<div className="my-auto w-auto p-2">
								<h3
									className={`text-pureBlack text-base text-center lg:text-left font-semibold mb-1`}
								>
									{name}
								</h3>
								<h4
