...
const ErrorPage: FC<IErrorPage> = ({
	...
	return (
		...
		>
				...
				<div className="lg:container p-0 mx-auto">
					...
					<div className="flex flex-col items-center justify-center mx-auto md:max-w-max">
						...
						>
							...
							>
								<div className="py-6 pl-4 pr-10 cursor-pointer bg-primary-default hover:bg-accent-dark transition-all duration-500 ease-in-out">
			...
			<div className="absolute top-0 h-screen bottom-0 left-0 w-full opacity-90 bg-gradient-to-b from-primary-darker from-5% via-primary-darker via-10% to-primary-darker to-100%" />
		</section>
	);
};
