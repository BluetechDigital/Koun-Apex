				...
				<div className="flex p-0 bg-white">
					...
					>
						<div className="w-full flex justify-end xl:justify-start gap-4 xl:gap-8 2xl:gap-12 xl:gap-12">
							...
							>
								<div className="flex items-center justify-center w-8 h-8 rounded-full bg-white sm:mr-1">
									<svg
										fill="none"
										viewBox="0 0 24 24"
										className="w-5 h-5"
								...
								<div className="flex flex-col items-baseline justify-center">
									<h3 className="font-medium uppercase text-tiny font-ObjectSans text-white">
										Need a Carpentry Specialists?
									</h3>
									<Link
										className="font-medium text-tiny font-PlusJakartaSans text-white"
										href={`tel:${globalContext?.themesOptionsContent?.phoneNumber}`}
										aria-label={`${globalContext?.themesOptionsContent?.phoneNumber}`}
									>
										<span>Call Us:</span>
										<span className="ml-2 font-medium text-tiny font-PlusJakartaSans text-white hover:opacity-70">
							...
							>
								...
								<div className="flex flex-col items-baseline justify-center">
									<h3 className="uppercase text-tiny font-ObjectSans text-white">
						...
						<div className="hidden xl:flex w-full xl:w-1/3 pr-4 flex-row items-center justify-end gap-2">
							<h3 className="hidden lg:block font-medium uppercase text-tiny font-ObjectSans text-white">
								Follow Us:
							</h3>
							<Link
												...
												{item?.node?.url === "/services" ? (
													...
													>
														<div className="flex flex-row justify-center items-center gap-2 cursor-pointer">
															<Link
																...
																className="font-ObjectSans uppercase text-pureBlack group-hover:text-primary-default text-tiny text-center"
															>
																{item?.node?.label}
															</Link>
															<Image
													...
													>
														<Link
															...
															aria-label={`${item?.node?.label}`}
															className="font-ObjectSans uppercase py-6 px-8 font-bold text-pureBlack hover:text-primary-default text-tiny text-center"
														>
															{item?.node?.label}
														</Link>
													</motion.li>
