		...
		<>
			<nav className={styles.navbar + ` navbar z-[999] h-fit w-full fixed`}>
				...
				<motion.div
					...
					whileInView="animate"
					viewport={{once: true}}
					className="bg-lightGreyTwo md:hidden w-full p-2 flex items-center justify-between lg:justify-start gap-2"
				>
				...
				<div className="bg-white w-full flex lg:grid grid-cols-3 gap-5 items-center justify-between px-4 lg:px-6">
					...
					<div className="flex items-center justify-end gap-4">
						<motion.div
							...
							whileInView="animate"
							viewport={{once: true}}
							className="hidden md:grid md:grid-cols-3 lg:hidden w-fit max-w-lg lg:max-w-full mx-auto lg:mx-0 py-[1px] px-4 2xl:grid 2xl:grid-cols-3 items-center justify-center lg:justify-start gap-4"
						>
