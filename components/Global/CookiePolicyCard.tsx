				...
				>
					...
					>
						<motion.button
							...
							whileInView={fadeInUp}
							viewport={{once: true}}
							className="inline-block px-6 py-3 mr-2 text-xs leading-none text-white transition-all duration-200 ease-in-out bg-primary-two hover:bg-accent-dark"
						>
							Accept Cookies
						</motion.button>
						<motion.button
							...
							whileInView={fadeInUp}
							viewport={{once: true}}
							className="inline-block px-6 py-3 text-xs leading-none text-white bg-accent-default hover:bg-accent-two"
						>
							Refuse Cookies
						</motion.button>
					</motion.div>
