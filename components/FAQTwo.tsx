						...
						<div className={image?.sourceUrl ? "w-full lg:w-1/2" : `hidden`}>
							...
							>
								...
								<Link
									...
									className={`w-fit mx-auto lg:mx-0 py-4 px-6 cursor-pointer bg-primary-two hover:bg-accent-two transition-all duration-500 ease-in-out font-semibold uppercase text-lightGrey text-base text-center font-ObjectSans ${
										buttonLink?.url
