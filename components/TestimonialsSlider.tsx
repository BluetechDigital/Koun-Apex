		...
		<>
			<div
				className={
					...
					` px-0 py-4 overflow-x-hidden bg-white border-t-[15px] border-solid border-primary-default`
				}
			>
											...
											>
												...
												>
													...
													<div className="relative flex flex-col lg:flex-row items-center">
														...
														>
															<h3 className="mb-2 max-w-sm lg:max-w-xl text-lg lg:text-xl font-semibold font-heading text-primary-default">
