...
> = ({
	...
	return (
		<>
			<Html>
				<Head />
				<Preview>Thank You for Contacting Max Lynn Carpentry Ltd</Preview>
				<Body style={main}>
					<Container style={container}>
						<EmailHeader
							imagesDirUrl={`${imagesDirUrl}/Max-Lynn-Carpentry-Ltd-Ltd-Email-Header.png`}
						/>
						<Section style={content}>
							<Text style={introParagraph}>Hi {firstName},</Text>
							<Text style={paragraph}>
								Thank you for reaching out to Max Lynn Carpentry Ltd regarding{" "}
							...
							<Text style={paragraph}>
								...
								<br />
								Website:{" "}
								<Link style={link} href={`https://maxlynncarpentry.co.uk`}>
									maxlynncarpentry.co.uk
								</Link>
							</Text>
						</Section>
						<EmailFooter
